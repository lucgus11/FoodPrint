...
function StepCapture({ onCapture, onBack, stepIndex }) {
  ...
  const cameraRef  = useRef(); // caméra  – avec capture="environment"
      ...
      <div className="scanner-step">
        ...
        {preview ? (
          <div style={{ position: 'relative', marginBottom: 16 }}>
            ...
            <button onClick={() => setPreview(null)} className="btn btn-secondary btn-sm" style={{ position: 'absolute', top: 10, right: 10, background: 'rgba(255,255,255,0.92)' }}>
              ✕ Rechoisir
            </button>
          </div>
        ) : (
        ...
        {/* Input caméra – capture="environment" ouvre directement l'appareil photo */}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          {preview ? (
            ...
            <>
              <button className="btn btn-primary btn-full btn-lg" onClick={() => cameraRef.current?.click()}>
